...
function updateBackground () {
    ...
    //if statements determining if hour is current past or pressent


    //if current add class of current check out this link w3schools.com/jquery/jquery_css_classes.asp
